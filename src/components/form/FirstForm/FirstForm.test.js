...
describe('Component renders correctly', () => {
  ...
  const HeaderWrap = mount(
    <ProviderProps.Provider lang="en">
      <FirstForm.wrappedComponent {...ProviderProps} />
  ...
  //   ).toMatch(/Submit/)
  // })
  it('has a FormattedMessage with the content of "Submit"', () => {
    expect(HeaderWrap.find('FormattedMessage').text()).toMatch(/Submit/)
  })
